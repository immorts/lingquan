...
public class OnSellPageAdapter extends RecyclerView.Adapter<OnSellPageAdapter.InnerHolder> {
    ...
    List<OnSellContent.DataBean.TbkDgOptimusMaterialResponseBean.ResultListBean.MapDataBean> mData = new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull InnerHolder holder, int position) {
        //TODO:绑定数据
        OnSellContent.DataBean.TbkDgOptimusMaterialResponseBean.ResultListBean.MapDataBean data = mData.get(position);
        holder.setData(data);
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mContentItemClickListener != null) {
                    mContentItemClickListener.onSellItemClick(data);
                }
            }
        });
    ...
    public class InnerHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.on_sell_original_prise_tv)
        ...
        public void setData(OnSellContent.DataBean.TbkDgOptimusMaterialResponseBean.ResultListBean.MapDataBean data) {
            ...
            LogUtils.d(this, "pict url -- >" + data.getPict_url());
            ...
            float originPrise = Float.parseFloat(originalPrise);
            float finalPrise = originPrise - couponAmount;
